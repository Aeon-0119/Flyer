...
const ITEMS = [
  ...
  { storeId:"aeon", category:"食品", group:"明治 チョコレート", flavor:"マカダミア", name:"明治 マカダミアチョコレート", price:268, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/meiji_maka.jpg" },
  { storeId:"aeon", category:"食品", group:"明治 チョコレート", flavor:"アーモンド", name:"明治 アーモンドチョコレート",   price:268, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/meiji_amo.jpg" },
  { storeId:"aeon", category:"食品", group:"東ハト ポテコ", flavor:"うましお", name:"東ハト ポテコ", price:98, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/po_umashio.jpg" },
  { storeId:"aeon", category:"食品", group:"東ハト ポテコ", flavor:"コンソメ", name:"東ハト ポテコ", price:98, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/po_konsome.jpg" },
  { storeId:"aeon", category:"食品", group:"亀田のうす焼", flavor:"サラダ", name:"亀田製菓 亀田のうす焼", price:128, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/ka_sarada.jpg" },
  { storeId:"aeon", category:"食品", group:"亀田のうす焼", flavor:"えび",   name:"亀田製菓 亀田のうす焼", price:128, unit:"各種", dateTo:"2026-01-31", note:"まで", image:"images/ka_ebi.jpg" },
  { storeId:"aeon", category:"食品", group:"ネスカフェ ゴールドブレンド", flavor:"通常", name:"ネスカフェ ゴールドブレンド", price:758, unit:"80g", dateTo:"2026-01-31", note:"まで", image:"images/ne_tu.jpg" },
  { storeId:"aeon", category:"食品", group:"ネスカフェ ゴールドブレンド", flavor:"コク深め", name:"ネスカフェ ゴールドブレンド", price:758, unit:"80g", dateTo:"2026-01-31", note:"まで", image:"images/ne_koku.jpg" },
  { storeId:"aeon", category:"食品", name:"森永 ホットケーキミックス", price:258, unit:"150g×4袋", dateTo:"2026-01-31", note:"まで", image:"images/hot.jpg" },
  { storeId:"aeon", category:"食品", group:"アクエリアス", flavor:"通常", name:"コカ・コーラ アクエリアス", price:98, unit:"500ml", dateTo:"2026-01-31", note:"まで", image:"images/akueri_tu.jpg" },
  { storeId:"aeon", category:"食品", group:"アクエリアス", flavor:"マルチビタミン", name:"アクエリアス", price:98, unit:"500ml", dateTo:"2026-01-31", note:"まで", image:"images/akueri_bita.jpg" },
