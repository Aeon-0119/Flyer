...
const ITEMS = [
  ...
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"シビ辛麻辣", name:"一平ちゃん夜店の焼きそば", price:129, unit:"76g", dateTo:"2026-01-31", note:"まで",image:"images/1763013_original.jpg"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"ソース焼きそば", name:"ごつ盛り", price:129, unit:"171g", dateTo:"2026-01-31", note:"まで",image:"images/hcgooday_9839472.jpg"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"塩焼きそば", name:"ごつ盛り", price:129, unit:"156g", dateTo:"2026-01-31", note:"まで",image:"images/hcgooday_9840911.jpg"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"カルボナーラ", name:"MARUCHANQTTA", price:129, unit:"114g", dateTo:"2026-01-31", note:"まで",image:"images/karubo.jpg"},
  ...
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"プレーン", name:"フルグラ", price:649, unit:"700g", dateTo:"2026-01-31", note:"まで",image:"images/10010004901330746360_1.jpg"},
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"糖質オフ", name:"フルグラ", price:649, unit:"550g", dateTo:"2026-01-31", note:"まで",image:"images/image_5-3.jpg"},
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"チョコバナナ", name:"フルグラ", price:649, unit:"550g", dateTo:"2026-01-31", note:"まで",image:"images/3n-shop_20230414-05_1_d_20230414213422.jpg"},
  ...
  {storeId: "dai", category:"菓子", group:"ハッピータン", flavor:"レギュラー", name:"ハッピータン", price:159, unit:"96g", dateTo:"2026-01-31", note:"まで",image:"images/207079_610_610-1.jpg"},
  {storeId: "dai", category:"菓子", group:"ハッピータン", flavor:"スパイス", name:"ハッピータン", price:159, unit:"73g", dateTo:"2026-01-31", note:"まで",image:"images/210215_1200_630.jpg"},
  {storeId: "dai", category:"菓子", group:"チョコ", flavor:"ラミー", name:"ラミーバッカス", price:249, unit:"3本入り", dateTo:"2026-01-31", note:"まで",image:"images/rami-r.jpg"},
  {storeId: "dai", category:"菓子", group:"チョコ", flavor:"バッカス", name:"ラミーバッカス", price:249, unit:"10粒入り", dateTo:"2026-01-31", note:"まで",image:"images/d2360-1612-19704ed3c7e91b1f79be-1.jpg"},
  {storeId: "dai", category:"菓子", group:"明治チョコ", flavor:"カカオ72%", name:"チョコレート効果大袋", price:980, unit:"225g", dateTo:"2026-01-31", note:"まで",image:"images/71vm-Ef4ZXL.jpg"},
  {storeId: "dai", category:"菓子", group:"明治チョコ", flavor:"カカオ86%", name:"チョコレート効果大袋", price:980, unit:"210g", dateTo:"2026-01-31", note:"まで",image:"images/511e8c9g9AL._SL500.jpg"},
