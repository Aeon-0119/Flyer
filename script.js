...
const ITEMS = [
  ...
  {storeId: "dai",category:"食品",group:"鍋キューブ", flavor:"濃厚白湯", name:"鍋キューブ", price:259, unit:"7個入り", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"鍋キューブ", flavor:"鶏だし・うま塩", name:"鍋キューブ", price:259, unit:"7個入り", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"鍋キューブ", flavor:"うま辛キムチ", name:"鍋キューブ", price:259, unit:"7個入り", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"鍋キューブ",flavor:"鶏だしコク醤油", name:"鍋キューブ", price:259, unit:"7個入り", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品", name:"棒状鍋用ラーメン", price:108, unit:"3人前",dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品", name:"キムチの素", price:199, unit:"190g",dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"エバラ",flavor:"おろしのたれ", name:"エバラ食品", price:198, unit:"270g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"エバラ",flavor:"にんにくのたれ", name:"エバラ食品", price:198, unit:"270g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カゴメ",flavor:"ウスター", name:"醸熟ソース", price:199, unit:"300ml", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カゴメ",flavor:"中濃", name:"醸熟ソース", price:199, unit:"300ml", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カゴメ",flavor:"とんかつ", name:"醸熟ソース", price:199, unit:"300ml", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"オイリオ",flavor:"やさし～く香るエキストラバージンオリーブオイル", name:"日清オイリオ", price:598, unit:"350g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"オイリオ",flavor:"さらっと軽いオリーブオイル", name:"日清オイリオ", price:598, unit:"350g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"ハウス商品",flavor:"クリーム", name:"シチューミクス", price:279, unit:"170g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"ハウス商品",flavor:"クリーム濃厚仕立て", name:"シチューミクス", price:279, unit:"170g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"わかめ",flavor:"しそ", name:"わかめ混ぜご飯", price:79, unit:"30g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"わかめ",flavor:"若菜", name:"わかめ混ぜご飯", price:79, unit:"30g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"わかめ",flavor:"明太子昆布", name:"わかめ混ぜご飯", price:79, unit:"30g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"シビ辛麻辣", name:"一平ちゃん夜店の焼きそば", price:129, unit:"76g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"ソース焼きそば", name:"ごつ盛り", price:129, unit:"171g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"塩焼きそば", name:"ごつ盛り", price:129, unit:"156g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai",category:"食品",group:"カップ麺",flavor:"カルボナーラ", name:"MARUCHANQTTA", price:129, unit:"114g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"プチコーン", flavor:"直火焼きトウモロコシ", name:"プチコーン",price:89, unit:"1袋",dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"プチコーン", flavor:"コーンマヨ", name:"プチコーン", price:89, unit:"1袋", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"クリスプ", flavor:"うましお", name:"クリスプ", price:89, unit:"1袋", dateTo:"2026-01-31",  note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"クリスプ", flavor:"旨味コンソメ", name:"クリスプ", price:89, unit:"1袋", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"とんがりコーン", flavor:"あっさり塩", name:"とんがりコーン", price:129, unit:"1個", dateTo:"2026-01-31", note:"まで", image:"images/"},
  {storeId: "dai", category:"菓子", group:"とんがりコーン", flavor:"焼きトウモロコシ", name:"とんがりコーン", price:129, unit:"1個", dateTo:"2026-01-31", note:"まで", image:"images/"},
  {storeId: "dai", category:"菓子", group:"とんがりコーン", flavor:"ハニーバター", name:"とんがりコーン", price:129, unit:"1個", dateTo:"2026-01-31", note:"まで", image:"images/"},
  {storeId: "dai", category:"菓子", group:"とんがりコーン", flavor:"あっさり塩", name:"とんがりコーン", price:129, unit:"1個", dateTo:"2026-01-31", note:"まで",image:"images/" },
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"プレーン", name:"フルグラ", price:649, unit:"700g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"糖質オフ", name:"フルグラ", price:649, unit:"550g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"フルグラ", flavor:"チョコバナナ", name:"フルグラ", price:649, unit:"550g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"コグミ", flavor:"フルーツアソート", name:"コグミ", price:108, unit:"1つ", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"コグミ", flavor:"ドリンクアソート", name:"コグミ", price:108, unit:"1つ", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ココナッツサブレ", flavor:"レギュラー", name:"ココナッツサブレ", price:99, unit:"各16枚", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ココナッツサブレ", flavor:"トリプルナッツ", name:"ココナッツサブレ", price:99, unit:"各16枚", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ココナッツサブレ", flavor:"発酵バター", name:"ココナッツサブレ", price:99, unit:"各16枚", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ココナッツサブレ", flavor:"アップルパイ", name:"ココナッツサブレ", price:99, unit:"各16枚", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ハッピータン", flavor:"レギュラー", name:"ハッピータン", price:159, unit:"96g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"ハッピータン", flavor:"スパイス", name:"ハッピータン", price:159, unit:"73g", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"チョコ", flavor:"ラミー", name:"ラミー", price:249, unit:"3本入り", dateTo:"2026-01-31", note:"まで",image:"images/"},
  {storeId: "dai", category:"菓子", group:"チョコ", flavor:"バッカス", name:"バッカス", price:249, unit:"10粒入り", dateTo:"2026-01-31", note:"まで",image:"images/youbetsuen-y_714.jpg"},
  {storeId: "dai", category:"菓子", group:"明治チョコ", flavor:"カカオ72%", name:"チョコレート効果大袋", price:980, unit:"225g", dateTo:"2026-01-31", note:"まで",image:"images/youbetsuen-y_714.jpg"},
  {storeId: "dai", category:"菓子", group:"明治チョコ", flavor:"カカオ86%", name:"チョコレート効果大袋", price:980, unit:"210g", dateTo:"2026-01-31", note:"まで",image:"images/youbetsuen-y_714.jpg"},
